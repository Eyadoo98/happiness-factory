<div>
    <div class="container mx-auto px-10">
        <div class="flex justify-between items-center  flex-col lg:flex-row">
            <div class="mb-11 lg:w-1/2 md:w-full rtl:md:w-full rtl:md:text-center rtl:items-center rtl:lg:w-1/2 text-center md:text-start ltr:md:text-center ltr:lg:text-start rtl:lg:text-start ">
                <h1 class="md:text-4xl text-3xl font-bold mb-6 text-center mx-auto md:mx-0 rtl:md:text-center md:text-start ltr:lg:text-start ltr:md:text-center rtl:lg:text-start">MADE WITH HAPPINESS</h1>
